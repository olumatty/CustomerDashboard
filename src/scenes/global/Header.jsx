      ...
      <div className="flex items-center justify-between flex-wrap">
        ...
        <div className="flex items-center gap-4 md:gap-8 mt-3 md:mt-0">
          ...
          <div className="hidden md:flex gap-2 md:gap-3 items-center">
            ...
            <span className="font-semibold md:text-base text-[12px]">Eng (US)</span>
            <img src={Arrow_down} alt="arrow" className="cursor-pointer h-4 w-4" />
          </div>

          {/* Notification Icon */}
          <div className="relative flex items-center h-10 w-10 md:h-10 md:w-10 bg-gradient-to-r from-[#FFA412]/20 to-[#FFFAF1]/60 rounded-lg">
          ...
          <div className="flex items-center gap-4 mr-4">
            <img src={Profile} alt="Profile" className="h-10 w-10 md:h-12 md:w-12 object-cover rounded-xl" />
            <div className="hidden md:flex flex-col">
              <div className="flex items-center gap-2">
                <span className="font-medium text-[14px]">Mustifq</span>
