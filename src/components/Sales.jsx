  ...
  return (
    <div className='bg-white rounded-lg h-auto lg:h-[260px] py-4 px-6 md:px-8'>
      ...
      <div className='mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:flex gap-4 md:gap-6 lg:gap-8'>
        ...
        {/* Total Sales */}
        <div className='bg-[#FFE2E5] lg:w-[140px] rounded-lg p-4 flex flex-col items-start'>
        ...
        {/* Total Order */}
        <div className='bg-[#FFF4DE] lg:w-[140px] rounded-lg p-4 flex flex-col items-start'>
        ...
        {/* Product Sold */}
        <div className='bg-[#DCFCE7] lg:w-[140px] rounded-lg p-4 flex flex-col items-start'>
        ...
        {/* New Customers */}
        <div className='bg-[#F3E8FF] lg:w-[140px] rounded-lg p-4 flex flex-col items-start'>
